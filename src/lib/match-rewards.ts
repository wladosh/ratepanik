 ...
 *
 * Hirncoins — a medium (10-minute) match lands around 40–80:
 ...
 *
 * Duration follows lobby length presets:
 *   short (≤6 questions) → 5 min (half)
 *   medium → 10 min
 *   long (16+) → 15 min (1.5×)
 *
 * Must stay in lockstep with grant_match_rewards.
 */
